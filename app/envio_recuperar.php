                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                    <tr>
                                                        <td align="center" valign="top" style="padding:0;Margin:0;width:520px">
                                                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                                <tr>
                                                                    <td align="center" style="padding:0;Margin:0"> <span class="es-button-border msohide" style="border-style:solid;border-color:#2CB543;background:#000000;border-width:0px;display:block;border-radius:30px;width:auto;mso-hide:all;mso-border-alt:10px"><a href="' . $dominio . '/app/entrar" target="_blank" class="es-button msohide" style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:22px;padding:15px 20px 15px 20px;display:block;background:#000000;border-radius:30px;font-family:Imprima, Arial, sans-serif;font-weight:bold;font-style:normal;line-height:26.4px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #4114F7;mso-hide:all;padding-left:5px;padding-right:5px;border-color:#7630f3">Confirmar email</a> </span> </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
...
$msn = 'Bem vindo,' . $nome . '%0A'
        ...
        . 'Confira sua nova senha clicando no botão abaixo e entrado com a sua nova senha: %0A %0A '
        . $senha . '%0A %0A '
        ...
        . '<a target="_blank" href="' . $dominio . '/app/entrar">' . $dominio . '/app/entrar</a> %0A %0A '
        . 'Obrigado, %0A '
        . $titulo_4;
?>