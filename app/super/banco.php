        ...
        function renderColumns() {
            ...
            columns.forEach((col, index) => {
                ...
                if (col.autoIncrement) {
                    ...
                    metaInputsHTML = `
                    <div class="row border p-3 mb-2 rounded" style="margin-left: 0px; margin-top: 10px;">
                        ...
                        <div class="col-md-12 mb-2">
                            <label class="form-label small fw-bold">Label da Tabela</label>
                        ...
                        <div class="col-12">
                            <div class="d-flex flex-wrap gap-3">
                                <div class="form-check"><input class="form-check-input" type="checkbox" id="add_${col.id}" ${col.metaAdd ? 'checked' : ''} onchange="updateColumnMeta(${col.id}, 'metaAdd', this.checked)"><label class="form-check-label small" for="add_${col.id}">Adicionar</label></div>
                                <div class="form-check"><input class="form-check-input" type="checkbox" id="edit_${col.id}" ${col.metaEdit ? 'checked' : ''} onchange="updateColumnMeta(${col.id}, 'metaEdit', this.checked)"><label class="form-check-label small" for="edit_${col.id}">Editar</label></div>
                                <div class="form-check"><input class="form-check-input" type="checkbox" id="delete_${col.id}" ${col.metaDelete ? 'checked' : ''} onchange="updateColumnMeta(${col.id}, 'metaDelete', this.checked)"><label class="form-check-label small" for="delete_${col.id}">Deletar</label></div>
                                <div class="form-check"><input class="form-check-input" type="checkbox" id="visible_${col.id}" ${col.metaVisible ? 'checked' : ''} onchange="updateColumnMeta(${col.id}, 'metaVisible', this.checked)"><label class="form-check-label small" for="visible_${col.id}">Visível</label></div>
                            </div>
                        </div>
                ...
                `;
                    ...
                    metaInputsHTML = `
                    <div class="row border p-2 mb-2 fk-section" style="margin-left: 0px;">
                ...
                <div class="card-body" style="${col.deleted ? 'opacity:0.5; pointer-events:none;' : ''}">
                    <div class="row g-2">
                        ...
                        <div class="col-6 col-md-3 mt-2">
                            ...
                            <div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" id="ai_${col.id}" ${col.autoIncrement ? 'checked' : ''} onchange="updateColumn(${col.id}, 'autoIncrement', this.checked)"><label class="form-check-label small" for="ai_${col.id}">Auto Increment</label></div>
                        </div>
                        <div class="col-6 col-md-3 mt-2">
