...
if ($action === 'create_node') {
    ...
    $stmt = mysqli_prepare($conecta, "INSERT INTO $tabela (parent_id_5, nivel_5, icone_5, texto_5, link_5, ordem_5) VALUES (?, ?, ?, ?, ?, ?)");
    if (!$stmt) json_err("Erro prepare: ".mysqli_error($conecta));
        mysqli_stmt_bind_param($stmt, "issssi", $parent_id, $nivel, $icone, $title, $link, $ordem_novo);
